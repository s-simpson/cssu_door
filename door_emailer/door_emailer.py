...
#  correctly.
#  Better to use the newer version of this program tweety_pi_emailer.py
#  
######################################################################
...
door_closed_tweet = "/home/pi/garage-door-controller/door_emailer/door_closed_tweets.txt"  #text file filled with random door closed tweet messages
door_open_tweet = "/home/pi/garage-door-controller/door_emailer/door_open_tweets.txt"      #text file filled with random door open tweet messages
passwords_file = "/home/pi/garage-door-controller/door_emailer/pwds.json"				   #json file created to store config/password information
